...
namespace database
{
    class Man
    {
        ...
        public Man(string s)
        {
            name = s.Substring(0, l_name); Console.WriteLine(name);
            birth_year = Convert.ToInt32(s.Substring(l_name, 4)); Console.WriteLine(birth_year);
            pay = Convert.ToDouble(s.Substring(l_name + 4)); Console.WriteLine(pay);
